...
class HORSellList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      dataList: []
  ...
  adsFetch = async () => {
    fetch(
      "http://52.65.228.235/api/v1/advertisements?ad_type=coin_ad&trade_type=sell&coin=HOR",
      {
        method: "GET",
        headers: undefined,
        body: undefined
...
export default withNavigation(HORSellList);
