...
export default class EditAdScreen extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
              ...
              lowest_volume: navigation.getParam('min'),
              highest_volume: navigation.getParam('max'),
              currency: navigation.getParam('currency'),
              limit: navigation.getParam('min_price'),
              ad_no: navigation.getParam('ad_no'),
              payment_method: navigation.getParam('payments')[0],
              payment_term: navigation.getParam('due_time'),
              message: navigation.getParam('remark'),
              coin: navigation.getParam('coin'),
              _coin: -1,
              type: navigation.getParam('ad_type').toUpperCase(),
              premium: navigation.getParam('margin'),
    ...
    AdInfoFetch = async () => {
        fetch('http://52.65.228.235/api/v1/advertisements/new?action_type=edit&ad_type=fiat_ad&trade_type=' + this.state.type.toLowerCase(), {
            method: 'GET',
            headers: {
            ...
            .then((responseJson) => {
              ...
              switch (responseJson.status) {
                case 200:
                  ...
                  console.log('Current Premium:'+this.state.premium);
                  console.log('Current lowest_volume:'+this.state.lowest_volume);
                  console.log('Current highest_volume Method:'+this.state.highest_volume);
                  console.log('============================================');
        ...
        return (
          ...
          <Header
              ...
              leftComponent={{
                  ...
                  onPress: () => { this.props.navigation.navigate('MyAd') }
              }}
              centerComponent={{
                  text: currentLanguages.SETTING_PAGE.EDIT,
                  style: {
                      fontSize: 20,
                      fontWeight: 'bold',
                ...
                <View style={styles.formView}>
                  ...
                  <View style={styles.item_detail}>
                    <Text style={{color: colorSchema.TEXT_HEADER_COLOR_3, fontSize:16, }}>
                      市场参考价格 {prices[this.state._coin]} {this.state.unit}/{this.state.coin}。基于市场的溢价比例
                  ...
                  <View style={styles.item}>
                    ...
                    <View style={{minWidth:100, margin:0, padding:0, height: 30,}}>
                      <Text style={{textAlign:'right',fontSize:16,color: colorSchema.TEXT_HEADER_COLOR_1, }}>
                        {parseFloat(prices[this.state._coin])*(1+parseFloat(this.state.premium)/100).toFixed(4)+' '+this.state.currency}
                      </Text>
                    </View>
                  </View>
                  <View style={styles.item_detail}>
                  ...
                  <View style={styles.item}>
                    ...
                    <View style={{maxWidth:300, margin:0, padding:0, height: 30, flexDirection:'row'}}>
                      <TextInput
                        ...
                        keyboardType = 'numeric'
                        value={this.state.type=='SELL'?currentLanguages.ADVERTISEMENT_PAGE.LOWEST_DETAIL:currentLanguages.ADVERTISEMENT_PAGE.HIGHEST_DETAIL}
                        placeholderTextColor={colorSchema.TEXT_HEADER_COLOR_3}
                  ...
                  <View style={styles.item}>
                    ...
                    <View style={{maxWidth:150, margin:0, padding:0, height: 30, flexDirection:'row'}}>
                      <TextInput
                        ...
                        keyboardType = 'numeric'
                        value={this.state.lowest_volume}
                        placeholderTextColor={colorSchema.TEXT_HEADER_COLOR_3}
                      />
                  ...
                  <View style={styles.item}>
                    ...
                    <View style={{maxWidth:150, margin:0, padding:0, height: 30, flexDirection:'row'}}>
                      <TextInput
                        ...
                        keyboardType = 'numeric'
                        value={this.state.highest_volume}
                        placeholderTextColor={colorSchema.TEXT_HEADER_COLOR_3}
                      />
                    </View><Text style={{textAlign:'right',fontSize:16,color: colorSchema.TEXT_HEADER_COLOR_1}}> {this.state.unit}</Text>
                  </View>
                  ...
                  <View style={styles.item}>
                    ...
                    <View style={{maxWidth:150, margin:0, padding:0, height: 30, flexDirection:'row'}}>
                      <TextInput
                        ...
                        keyboardType = 'numeric'
                        value={this.state.remaining_quantity}
                        placeholderTextColor={colorSchema.TEXT_HEADER_COLOR_3}
                      />
                    </View>
                  </View>
